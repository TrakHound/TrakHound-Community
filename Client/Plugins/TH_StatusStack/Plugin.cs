...
namespace TH_StatusStack
{
    public partial class DeviceTable : IClientPlugin
    {
        ...
        public string Title { get { return "Status Stack"; } }

        public string Description { get { return "Compare Device Status in a 'Light Stack' style table"; } }

        public ImageSource Image { get { return new BitmapImage(new Uri("pack://application:,,,/TH_StatusStack;component/Resources/List_01.png")); } }
