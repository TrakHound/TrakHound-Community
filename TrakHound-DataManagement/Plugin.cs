...
namespace TrakHound.Databases.Plugins.SQLite
{
    public partial class Plugin : IDatabasePlugin
    {
        ...
        public void Initialize(Database_Configuration config)
        {
            ...
            Logger.Log(Type + " Successfully Initialized : " + GetDatabasePath(c), LogLineType.Notification);
        }
        ...
        public static object ExecuteQuery<T>(Configuration config, string query, int attempts = 3, int failureDelay = 500)
        {
            object result = null;
        ...
        public static object ProcessResult<T>(SQLiteCommand command)
        {
            object result = null;
        ...
        public const string dateString = "yyyy-MM-dd HH:mm:ss";
