...
namespace TrakHound_Dashboard.Pages.DeviceManager.Pages.GeneratedEvents.Controls
{
    ...
    public partial class Event : UserControl
    {
        ...
        private void AddValue_Clicked(TrakHound_UI.Button bt)
        {
            AddValueClicked?.Invoke(this);
        }
        ...
        private void AddCaptureItem_Clicked(TrakHound_UI.Button bt)
        {
            AddCaptureItemClicked?.Invoke(this);
        }
