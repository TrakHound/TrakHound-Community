...
namespace TrakHound_Dashboard.Pages.Dashboard.DeviceStatusHourTimeline
{
    public partial class DeviceStatusHourTimeline : IClientPlugin
    {

        #region "Descriptive"

        public string Title { get { return "Device Status Hour Timeline"; } }
        ...
        //                if (newConfig != null)
        //                {
        //                    Dispatcher.BeginInvoke(new Action<DeviceConfiguration>(AddRow), UI_Functions.PRIORITY_BACKGROUND, new object[] { newConfig });
        //                }
