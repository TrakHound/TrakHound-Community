...
namespace TH_StatusTimeline
{
    public partial class StatusTimeline : IClientPlugin
    {
        ...
        public string Title { get { return "Status Timeline"; } }

        public string Description { get { return "View Device Status Timeline for the current day"; } }

        public ImageSource Image { get { return new BitmapImage(new Uri("pack://application:,,,/TrakHound-Dashboard;component/Resources/Outline_01.png")); } }
