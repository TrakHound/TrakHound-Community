...
namespace TrakHound_Dashboard.Pages.Dashboard.OeeStatus
{
    public partial class Plugin : IClientPlugin
    {
        ...
        public Uri Image { get { return new Uri("pack://application:,,,/TrakHound-Dashboard;component/Resources/Oee_Percent_03.png"); } }
        ...
        public static readonly DependencyProperty IsScrollbarVisibleProperty =
            DependencyProperty.Register("IsScrollbarVisible", typeof(bool), typeof(Plugin), new PropertyMetadata(false));
        ...
        void Update(EventData data)
        {
            ...
            if (data != null && data.Id == "STATUS_OEE" && data.Data01 != null && data.Data02 != null && data.Data02.GetType() == typeof(Data.OeeInfo))
            {
                Dispatcher.BeginInvoke(new Action(() =>
                {
                    string uniqueId = data.Data01.ToString();
