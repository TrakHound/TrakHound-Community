...
namespace TrakHound_Dashboard.Pages.Plugins.Installed
{
    ...
    public partial class ListItem : UserControl
    {
        ...
        TrakHound_Dashboard.MainWindow mw;
        ...
        private void MenuItem_About_Click(object sender, RoutedEventArgs e)
        {
            ...
            //    mw.AddPageAsTab(dummy, "About | " + Plugin_Title, new BitmapImage(new Uri("pack://application:,,,/TrakHound-Dashboard;component/Resources/About_01.png")));
            //}
        }
