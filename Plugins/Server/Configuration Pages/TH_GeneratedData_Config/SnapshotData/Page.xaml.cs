    ...
    public partial class Page : UserControl, IConfigurationPage
    {
        ...
        public ImageSource Image
        {
            get
            {
                if (_image == null)
                {
                    _image = new BitmapImage(new Uri("pack://application:,,,/TH_GeneratedData_Config;component/Resources/Camera_01.png"));
                    _image.Freeze();
                }
        ...
        //        int index = SnapshotItems.ToList().FindIndex(x => x.ParentSnapshot.Name == snapshot.Name);
        //        if (index >= 0) SnapshotItems.RemoveAt(index);
