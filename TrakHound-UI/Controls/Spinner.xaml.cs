...
namespace TrakHound_UI
{
    ...
    public partial class Spinner : UserControl
    {
        ...
        public static readonly DependencyProperty ForegroundProperty =
            DependencyProperty.Register("Foreground", typeof(SolidColorBrush), typeof(Spinner), new PropertyMetadata(new SolidColorBrush(Colors.Black), new PropertyChangedCallback(Foreground_PropertyChanged)));

        private static void Foreground_PropertyChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
        {
            var w = obj as Spinner;
            if (w != null)
            {
        ...
        public static readonly DependencyProperty ColorProperty =
            DependencyProperty.Register("Color", typeof(Color), typeof(Spinner), new PropertyMetadata(Colors.Black, new PropertyChangedCallback(Color_PropertyChanged)));
        ...
        public static readonly DependencyProperty Color1Property =
            DependencyProperty.Register("Color1", typeof(Color), typeof(Spinner), new PropertyMetadata(Colors.Black));
        ...
        public static readonly DependencyProperty Color2Property =
            DependencyProperty.Register("Color2", typeof(Color), typeof(Spinner), new PropertyMetadata(Color.FromArgb(170, 0, 0, 0)));
        ...
        public static readonly DependencyProperty Color3Property =
            DependencyProperty.Register("Color3", typeof(Color), typeof(Spinner), new PropertyMetadata(Color.FromArgb(136, 0, 0, 0)));
        ...
        public static readonly DependencyProperty Color4Property =
            DependencyProperty.Register("Color4", typeof(Color), typeof(Spinner), new PropertyMetadata(Color.FromArgb(17, 0, 0, 0)));
