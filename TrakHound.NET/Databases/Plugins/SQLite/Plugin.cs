...
namespace TrakHound.Databases.Plugins.SQLite
{
    public partial class Plugin : IDatabasePlugin
    {
        ...
        static string GetConnectionString(Configuration config)
        {
            return "Data Source=" + GetDatabasePath(config) + "; Version=3; Pooling=True; Max Pool Size=300;";
        }

        static object ExecuteQuery<T>(Configuration config, string query, int attempts = 3, int failureDelay = 500)
        {
            object result = null;
