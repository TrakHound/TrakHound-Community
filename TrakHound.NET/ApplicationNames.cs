...
namespace TrakHound
{
    public static class ApplicationNames
    {
        ...
        public const string TRAKHOUND_DASHBOARD = "trakhound-dashboard";
        public const string TRAKHOUND_SERVER = "trakhound-server";


        /// <summary>
        /// Name of the TrakHound-Client Process Name
        /// </summary>
        public const string TRAKHOUND_CLIENT_PROCESS_NAME = "TrakHound-Client";
