...
namespace TrakHound.Server.Plugins.Cycles
{
    public class Cycles : IServerPlugin
    {
        ...
        public string Name { get { return "TrakHound.Server.Plugins.Cycles"; } }
        ...
        private List<CycleData> ProcessCycleEvent(Event cycleEvent, InstanceData instanceData, CycleConfiguration cc)
        {
            ...
            if (instanceValue != null)
            {
                ...
                if (eventReturn != null)
                {
                    ...
                    TrakHound.Server.Plugins.Shifts.CurrentShiftInfo startShiftInfo = null;
                    TrakHound.Server.Plugins.Shifts.CurrentShiftInfo endShiftInfo = null;

                    // Get ShiftId from Timestamp
                    if (cycleData != null) startShiftInfo = TrakHound.Server.Plugins.Shifts.CurrentShiftInfo.Get(configuration, cycleData.StartTime);
                    if (instanceData != null) endShiftInfo = TrakHound.Server.Plugins.Shifts.CurrentShiftInfo.Get(configuration, instanceData.Timestamp);
        ...
        private static string GetShiftId(TrakHound.Server.Plugins.Shifts.CurrentShiftInfo info)
        {
        ...
        private CycleData CreateCycleData(string name)
        {
            ...
            result.CycleId = Guid.NewGuid().ToString();
            result.Name = name;
        ...
        {         
            var shiftId = TrakHound.Server.Plugins.Shifts.CurrentShiftInfo.Get(configuration, data.Timestamp);
