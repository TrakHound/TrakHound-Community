...
using TrakHound_Overview.Controls;
...
namespace TrakHound_Overview
{
    public partial class Overview
    {
        ...
        void AddRowHeaders(List<IClientPlugin> plugins, List<PluginConfiguration> configs)
        {
            ...
            {
                rowHeader.IndexChanged -= RowHeader_IndexChanged;
                rowHeader.ResetOrder -= Header_ResetOrder;
            }
        ...
        private void ColumnHeaderMinimize_Clicked(TrakHound_UI.Button bt)
        {
        ...
        private void ColumnHeaderMaximize_Clicked(TrakHound_UI.Button bt)
        {
            HeaderViewType viewType = HeaderViewType.Large;
        ...
        public static readonly DependencyProperty ViewTypeProperty =
            DependencyProperty.Register("ViewType", typeof(HeaderViewType), typeof(Overview), new PropertyMetadata(HeaderViewType.Large));
