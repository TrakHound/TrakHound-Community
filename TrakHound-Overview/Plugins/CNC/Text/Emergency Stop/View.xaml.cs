...
namespace TH_DeviceCompare_CNC.Text.Emergency_Stop
{
    /// <summary>
    ...
    public partial class Plugin : UserControl
    {
        ...
        const string SNAPSHOT_LINK = "Emergency Stop";
        const string STATUS_LINK = "EMERGENCY_STOP";
            ...
            if (data != null && data.Data01 != null)
            {
                if (data != null && data.Id == "STATUS_CONTROLLER")
                {
                    Dispatcher.BeginInvoke(new Action(() =>
                    {
                        ...
                        ProcessValue(info.EmergencyStop);
