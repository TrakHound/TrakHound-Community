...
namespace TrakHound_Overview.Controls.DeviceDisplay
{
    ...
    {
        public Column(TrakHound_Overview.DeviceDisplay parent)
        {
            InitializeComponent();
            DataContext = this;
        ...
        public TrakHound_Overview.DeviceDisplay ParentDisplay
        {
            get { return (TrakHound_Overview.DeviceDisplay)GetValue(ParentDisplayProperty); }
            set { SetValue(ParentDisplayProperty, value); }
        }

        public static readonly DependencyProperty ParentDisplayProperty =
            DependencyProperty.Register("ParentDisplay", typeof(TrakHound_Overview.DeviceDisplay), typeof(Column), new PropertyMetadata(null));
