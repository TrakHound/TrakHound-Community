...
namespace TrakHound_Device_Manager.Pages.Shifts.Controls
{
    ...
    public partial class ShiftListItem : UserControl
    {
        ...
        private void EditShiftName_Clicked(TrakHound_UI.Button bt)
        {
        ...
        private void RemoveShift_Clicked(TrakHound_UI.Button bt)
        {
        ...
        private void AddBreak_Clicked(TrakHound_UI.Button bt)
        {
            AddBreakTime();
        }
