...
namespace TrakHound_Device_Manager.AddDevice.Pages
{
    ...
    public partial class LoadFromFile : UserControl, IPage
    {
        ...
        public ImageSource Image { get { return new BitmapImage(new Uri("pack://application:,,,/TrakHound-Device-Manager;component/Resources/List_01.png")); } }
        ...
        private bool LoadDevice(string path)
        {
            ...
            if (config != null)
            {
                ...
                {
                    result = TrakHound.API.Devices.Update(ParentPage.DeviceManager.CurrentUser, config);
                }
